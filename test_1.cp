#line 1 "C:/sugarsync/wireless_spi/test_1.c"
...
void DelayMs( unsigned int  ms);
#line 11 "C:/sugarsync/wireless_spi/test_1.c"
...
void RFSendPacket( unsigned short Key )
{
 ...
 SwitchToTxMode();
  ...
  PORTC.F0  = 0;
 SPI_Write_Buf( 0xA0 ,(unsigned short *)&g_RFSendBuff, 5 );
 g_RFIRQValid =  0 ;
  PORTC.F0  = 1;
 delay_us(25);
  PORTC.F0  = 0;
